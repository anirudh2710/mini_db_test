...
# the data are shared via UBBox
# just in case the students forgot to add the gitignore lines....
echo "/data/tpch_s1.tar.xz" >> .gitignore
echo "/data/tpch_s1" >> .gitignore
echo "/data/tpch_s01.tar.xz" >> .gitignore
echo "/data/tpch_s01" >> .gitignore
...
echo ""
echo "Please download the preloaded TPC-H data from UBBox and extract them into data directory"
echo "See Piazza annoucement for details"
